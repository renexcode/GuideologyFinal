...
var venmoUsername = document.getElementById('venmo_Username');
var cashappUsername = document.getElementById('cashapp_Username');
...
referAFriendiewForm.addEventListener('submit', (e) => {
  ...
  if (!member1_Name.value || !member1_Email.value || !member1_Phone.value || !venmoUsername.value || !cashappUsername.value || !member2_Name.value || !member2_Email.value || !member2_Phone.value  ) return null
  ...
  db.ref('referafriend/' + id).set({
    ...
    venmoUsername: venmoUsername.value,
    cashappUsername: cashappUsername.value,
