...
const topDataFun = () => {
    ...
    if (!term || !year || !academicStatus || !completionStatus) return null
      ...
      db.ref('tableHeader/' + id).set(tableHeader);
      document.getElementById('topForm').innerHTML = `"Your form has been submitted <i class="bi bi-check-circle" style="color:green"></i>"`
