...
const generateSemesterView = () => {
    ...
    for (let index = 0; index < academicMasterData.length; index++) {
         ...
         const table = document.createElement('tr');
            ...
            <td class="col-lg-2 col-md-2"> 
             ...
             <td class="col-lg-2 col-md-2 btn-field">
                <button data-toggle="modal" data-target="#editexperienceModal${item.id}" id="isEdit${item.id}${index}">Edit</button>
        ...
        <div class="modal fade" id="isDelete${item.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          ...
          <!--Edit Modal--->
<div class="modal fade" id="editexperienceModal${item.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered" role="document">
<div class="modal-content">
<div class="modal-header">
