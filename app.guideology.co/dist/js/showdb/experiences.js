...
//     // apiKey: "AIzaSyB1kOcWwHaT0cMXdn1vnJ4Ft66P7eHgNAg",
//     // authDomain: "guideology-969d6.firebaseapp.com",
//     // projectId: "guideology-969d6",
//     // storageBucket: "guideology-969d6.appspot.com",
//     // messagingSenderId: "396716570133",
//     // appId: "1:396716570133:web:77b302327f24f65145801c",
//     // measurementId: "G-0EWXZX9NFR"
...
// // Semester ka data save hony k bd database sy jo ara hy

// const generateSemesterView = () => {
//     console.log(academicMasterData, "Master");
...
//               courseDataView(item.coruseData, tableId);
//          }
//     }
// }
// // GENERATE COURSE TABLE VIEW

// // Course ka data save hony k bd database sy jo data ara hy wo show krwry hn UI pr
// // Need this function
// const courseDataView = (coruse, tableId) => {
//     const table = document.getElementById(tableId);
//     table.innerHTML = '';

//     if (coruse) {
//          for (let index = 0; index < coruse.length; index++) {
//               const item = coruse[index];
...
//                                   </td>
//                                   <td class="col-lg-2 col-md-2">
//                                      <input type="text" class="form-control uname-box" id="popupCredits${tableId}${index}" aria-describedby="emailHelp" placeholder="Credits" value="${item.popupCredits}" readonly>
//                                   </td>
//                                   <td class="col-lg-2 col-md-2"> 
...
//                                      <button data-toggle="modal" data-target="#isDeleteCoruse${table}${index}">Delete</button>
//                                   </td>
//                              </tr>
                             
//                              <!---Confirmation Modal---->
//                              <div class="modal fade" id="isDeleteCoruse${table}${index}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
//                                <div class="modal-dialog modal-dialog-centered" role="document">
//                                   <div class="modal-content">
//                                        <div class="modal-header">
//                                             <h5 class="modal-title" id="exampleModalLongTitle"> Delete ${item.popupCourseTitle} </h5>
//                                             <button type="button" class="close" data-dismiss="modal" aria-label="Close">
//                                                  <span aria-hidden="true">&times;</span>
//                                             </button>
//                                        </div>
...
//     } else {
//          const tr = document.createElement('tr');
//          tr.innerHTML = '<td><p style="text-align: center;">NO CHANGES</p></td>';
//          table.appendChild(tr)
//     }
// }
// // CREATE NEW COURSE TABLE VIEW

// // Add course k button pr click krky jo course add krny ka option ara hy ya wo hy
// // Don't need extra work
...
//          <td class="col-lg-2 col-md-2"> <input type="text" class="form-control uname-box" id="popupCredits" aria-describedby="emailHelp" placeholder="Credits"></td>
...
// // ADD NEW SEMESTER
// // Semester ko database me save krwany ka function
...
// Course ko database me add krny ka function
...
// // Agr 1, 1 input ko alg alg edit krna ho tw ya function use hoga
// // Need this function
// * @param {element} btn 
// * @param {number} semesterID 
