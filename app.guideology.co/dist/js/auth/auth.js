function showPassword() {
  ...
  password = document.getElementById('password').value;
   ...
   if (phone_number.length < 10)  {
    ...
    document.getElementById('notsuccess').innerHTML='Please select country code!'
    return;
    }

    else if (password.length < 8) {
      // alert('Password should be at least 8 characters long!');
      document.getElementById('notsuccess').innerHTML='Password should be at least 8 characters long!'
      return ;
    }
