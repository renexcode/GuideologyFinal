...
console.log(`Collaburations ==>>>>>>>> ${collaborations}`)
  if (collaborations_fullName !== ""|| collaborations_email !== ""|| collaborations_phone !== ""|| collaborations_phone !== ""|| collaborations_organization !== ""|| officer_position !== ""|| number0fActiveMembers !== ""|| number0fActiveMembers !== ""){
    ...
    db.ref('collaborations/' + id).set(collaborations);
...
//   else{
//      document.getElementById('collaborations_para').innerHTML = `"Empty email/getting server error <i class="bi bi-x-circle" style="color:red"></i>"`
