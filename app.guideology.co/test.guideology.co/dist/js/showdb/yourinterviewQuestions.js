...
const generateSemesterView = () => {
    ...
    for (let index = 0; index < academicMasterData.length; index++) {
         ...
         const tr = document.createElement('tr');
            ...
            tr.innerHTML = `
            <td class="col-lg-10">
            <label style="color:black; "><b> Dental School Name: </b></label> <br> <p style="line-break: anywhere;"> ${item.dentalName} </p> <br> <label style="color:black; "><b>Your Question: </b></label> <br> <p style="line-break: anywhere;"> ${item.interviewQuestions} </p>
            </td>
                                ...
                                <div class="col-sm-12 list">
                                    <div class="mb-2 row justify-content-between">
                                        ...
                                        <div class="mob mb-2">
                                            ...
                                            <textarea value="${item.interviewQuestions}" placeholder="Type here..." id="iques${item.id}" maxlength="600" cols="6" rows="12" class="form-control" required> ${item.interviewQuestions} </textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
